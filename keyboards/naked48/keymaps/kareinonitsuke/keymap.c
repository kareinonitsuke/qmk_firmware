...
(\
   ...
   KC_ESC,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                                             KC_N,                   KC_M,    KC_COMM,  KC_DOT,  KC_SLSH,  KC_ESC,\
             KC_LWIN, KC_NO,   ADJUST,  KC_LALT, LT(MO(_LOWER), KC_SPC), LCTL_T(KC_DEL),         LSFT_T(KC_BSPC),  LT(MO(_RAISE), KC_ENT), KC_BSPC, KC_NO,    KC_NO,   KC_NO,\
  ), 
  ...
  [_ADJUST] = LAYOUT(\
    RESET,   RESET,   RGBRST,  KC_NO,   KC_NO,   KC_NO,                                                        KC_NO,              KC_NO,   KC_NO,   KC_NO,    KC_NO,    KC_NO\
